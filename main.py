...
directory = "c:/Users/jinwon/Desktop/"
...
def read_file(path):
    ...
    print(df)
    with pd.ExcelWriter("c:/Users/jinwon/Desktop/테마.xlsx") as writer:
        df.to_excel(writer, sheet_name='사료')


# 스크립트를 실행하려면 여백의 녹색 버튼을 누릅니다.
if __name__ == '__main__':
    file_path = directory + '사료테마.txt'
    read_file(file_path)
